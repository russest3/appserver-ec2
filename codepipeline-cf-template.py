...
t.add_description("CodePipeLine Template")
...
t.add_resource(Role(
    "CloudFormationRole",
    RoleName="CloudFormationApplicationRole",
    Path="/",
    AssumeRolePolicyDocument=Policy(
        Statement=[
            Statement(
    ...
    Policies=[
        IAMPolicy(
            PolicyName="ApplicationCloudFormationRole",
            PolicyDocument={
                "Statement": [
                    {"Effect": "Allow", "Action": "cloudformation:*", "Resource": "*"},
                    {"Effect": "Allow", "Action": "ecr:*", "Resource": "*"},
            ...
            Actions=[
                Actions(
                    ...
                    Configuration={
                        ...
                        "StackName": "staging-helloworld-service2",
